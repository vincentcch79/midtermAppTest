...
//    var movieIntroduction = ["", ""]
    ...
    var movie:[movies] = [
        movies(name: "The Assassin", image: "Assassin", intro: "8th century China. 10-year-old general's daughter Nie Yinniang is abducted by a nun who initiates her into the martial arts, transforming her into an exceptional assassin charged with eliminating cruel and corrupt local governors."),
        movies(name: "SW Force Awakens", image: "Starwars", intro: "30 years after the defeat of Darth Vader and the Empire, Rey, a scavenger from the planet Jakku, finds a BB-8 droid that knows the whereabouts of the long lost Luke Skywalker.")
    ]
